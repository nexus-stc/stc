    ...
    nexus_media: [
      {
        collector: {
          top_docs: {
            ...
            scorer: options.is_date_sorting_enabled ? { scorer: { order_by: "registered_at" }} : options.is_temporal_scoring_enabled
              ? {
                  scorer: {
    ...
    nexus_free: [
      {
        collector: {
          top_docs: {
            ...
            scorer: options.is_date_sorting_enabled ? { scorer: { order_by: "issued_at" }} : options.is_temporal_scoring_enabled
              ? {
                  scorer: {
